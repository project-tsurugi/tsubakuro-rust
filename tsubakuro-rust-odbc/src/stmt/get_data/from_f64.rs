...
pub(crate) fn get_data_f64(
    ...
    match target_type {
        CDataType::SQL_C_BIT => write_bool(value != 0f64, target_value_ptr, str_len_or_ind_ptr),
        ...
        CDataType::SQL_C_NUMERIC => match f64_to_decimal(stmt, value) {
