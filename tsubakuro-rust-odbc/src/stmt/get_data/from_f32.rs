...
pub(crate) fn get_data_f32(stmt: &TsurugiOdbcStmt, arg: GetDataArguments, value: f32) -> SqlReturn {
    ...
    match target_type {
        SQL_C_BIT => write_bool(arg, value != 0f32),
        ...
        SQL_C_FLOAT => write_f32(arg, value),
        SQL_C_DOUBLE => write_f64(arg, value as f64),
        SQL_C_NUMERIC => match f32_to_decimal(stmt, value) {
