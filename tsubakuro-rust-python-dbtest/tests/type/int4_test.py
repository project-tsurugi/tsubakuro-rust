...
def test_wrapper():
    ...
    value = tsurugi.Int32(None)
    assert value.value is None
    value = tsurugi.Int32(123)
    assert value.value == 123
    value = tsurugi.Int32("123")
    assert value.value == 123
    try:
        value = tsurugi.Int32("abc")
...
def test_placeholder_wrapper(connection):
    ...
    with connection.cursor() as cursor:
        parameters = [
            (tsurugi.Int32(0), tsurugi.Int32(None)),
            (1, 1),
            (2, 0),
            (3, -2147483648),
            (4, 2147483647),
...
def test_named_placeholder(connection):
    ...
    with connection.cursor() as cursor:
        parameters = [
            {"pk": tsurugi.Int32(0), "value": tsurugi.Int32(None)},
            {"pk": tsurugi.Int32(1), "value": tsurugi.Int32(1)},
            {"pk": tsurugi.Int32(2), "value": tsurugi.Int32(0)},
        ]
        cursor.executemany(
...
def test_prepare_named(connection):
    ...
    with connection.cursor() as cursor:
        ...
        cursor.prepare(
            insert,
            {"pk": tsurugi.Int32, "value": tsurugi.Int32},
        )
        parameters = [
            {"pk": 0, "value": None},
            {"pk": 1, "value": 1},
