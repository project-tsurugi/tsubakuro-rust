...
- `execute`, `executemany` メソッドのパラメーターとしてPythonの型の値が使用されたとき、Tsurugiのプレースホルダーの型としては、intはBIGINT, floatはDOUBLE, bytesはBINARY, strはCHARとして扱われます。
