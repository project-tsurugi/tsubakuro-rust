...
（後者の方法でも、内部ではConfigオブジェクトを構築します。設定できる内容については [APIドキュメントのConfig](https://tsurugi-dbapi.readthedocs.io/latest/#tsurugi_dbapi.Config) を参照してください）
...
テーブル定義から取得できる情報については [APIドキュメントのTableMetadata](https://tsurugi-dbapi.readthedocs.io/latest/#tsurugi_dbapi.TableMetadata) を参照してください。
...
TransactionOptionオブジェクトの生成方法および設定内容については [APIドキュメントのTransactionOption](https://tsurugi-dbapi.readthedocs.io/latest/#tsurugi_dbapi.TransactionOption) を参照してください。
...
どのようなラッパークラスがあるのかについては、[APIドキュメントのtype_code](https://tsurugi-dbapi.readthedocs.io/latest/type_code/index.html) を参照してください。
