...
public class TgFfiSession extends TgFfiObject {
    ...
    public static TgFfiSession connect(TgFfiObjectManager manager, TgFfiContext context, TgFfiConnectionOption connectionOption) {
    ...
    public static TgFfiSession connectFor(TgFfiContext context, TgFfiConnectionOption connectionOption, Duration timeout) {
        Objects.requireNonNull(context, "context must not be null");
        return connectFor(context.manager(), context, connectionOption, timeout);
    }

    public static TgFfiSession connectFor(TgFfiObjectManager manager, TgFfiConnectionOption connectionOption, Duration timeout) {
        return connectFor(manager, null, connectionOption, timeout);
    }

    public static TgFfiSession connectFor(TgFfiObjectManager manager, TgFfiContext context, TgFfiConnectionOption connectionOption, Duration timeout) {
        Objects.requireNonNull(manager, "manager must not be null");
    ...
    private static TgFfiSession connectForMain(TgFfiObjectManager manager, TgFfiContext context, TgFfiConnectionOption connectionOption, Duration timeout) {
        var ctx = (context != null) ? context.handle() : MemorySegment.NULL;
        var arg = connectionOption.handle();
    ...
    public static TgFfiJob<TgFfiSession> connectAsync(TgFfiObjectManager manager, TgFfiConnectionOption connectionOption) {
        return connectAsync(manager, null, connectionOption);
    }

    public static TgFfiJob<TgFfiSession> connectAsync(TgFfiObjectManager manager, TgFfiContext context, TgFfiConnectionOption connectionOption) {
        Objects.requireNonNull(manager, "manager must not be null");
        Objects.requireNonNull(connectionOption, "connectOption must not be null");
