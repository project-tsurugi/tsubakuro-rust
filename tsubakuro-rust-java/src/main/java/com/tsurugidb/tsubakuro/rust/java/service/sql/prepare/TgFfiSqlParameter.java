...
public class TgFfiSqlParameter extends TgFfiObject {
	...
	private static TgFfiSqlParameter ofInt4Main(TgFfiObjectManager manager, TgFfiContext context, String name,
			int value) {
		var ctx = (context != null) ? context.handle() : MemorySegment.NULL;
		var arg1 = manager.allocateString(name);
		var arg2 = value;
	...
	private static TgFfiSqlParameter ofInt8Main(TgFfiObjectManager manager, TgFfiContext context, String name,
			long value) {
		var ctx = (context != null) ? context.handle() : MemorySegment.NULL;
		var arg1 = manager.allocateString(name);
		var arg2 = value;
	...
	public static TgFfiSqlParameter ofFloat4(TgFfiObjectManager manager, TgFfiContext context, String name,
			float value) {
		Objects.requireNonNull(manager, "manager must not be null");
	...
	private static TgFfiSqlParameter ofFloat4Main(TgFfiObjectManager manager, TgFfiContext context, String name,
			float value) {
		var ctx = (context != null) ? context.handle() : MemorySegment.NULL;
		var arg1 = manager.allocateString(name);
		var arg2 = value;
	...
	public static TgFfiSqlParameter ofFloat8(TgFfiObjectManager manager, TgFfiContext context, String name,
			double value) {
		Objects.requireNonNull(manager, "manager must not be null");
	...
	private static TgFfiSqlParameter ofFloat8Main(TgFfiObjectManager manager, TgFfiContext context, String name,
			double value) {
		var ctx = (context != null) ? context.handle() : MemorySegment.NULL;
		var arg1 = manager.allocateString(name);
		var arg2 = value;
	...
	public static TgFfiSqlParameter ofCharacter(TgFfiObjectManager manager, TgFfiContext context, String name,
			String value) {
		Objects.requireNonNull(manager, "manager must not be null");
	...
	private static TgFfiSqlParameter ofCharacterMain(TgFfiObjectManager manager, TgFfiContext context, String name,
			String value) {
		var ctx = (context != null) ? context.handle() : MemorySegment.NULL;
		var arg1 = manager.allocateString(name);
