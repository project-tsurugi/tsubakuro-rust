...
public class TgFfiSqlPlaceholder extends TgFfiObject {
	...
	public static TgFfiSqlPlaceholder ofAtomType(TgFfiObjectManager manager, TgFfiContext context, String name,
			TgFfiAtomType atomType) {
	...
	private static TgFfiSqlPlaceholder ofAtomTypeMain(TgFfiObjectManager manager, TgFfiContext context, String name,
			TgFfiAtomType atomType) {
