...
public class TgOdbcExampleMain {
    ...
    private static final boolean wideChar = true;
...
//                  hdbc.setConnectAttr(ConnectionAttribute.SQL_ATTR_ANSI_APP, 0, wideChar);
    ...
    private static List<TableName> doTables(TgOdbcConnection connection) {
    ...
    private static List<ColumnInfo> doColumns(TgOdbcConnection connection, String tableName) {
        try (var stmt = connection.createStmt()) {
    ...
    private static List<PrimaryKey> doPrimaryKeys(TgOdbcConnection connection, String tableName) {
        try (var stmt = connection.createStmt()) {
